...
class Helper:
    ...
    def get_int(self, string):
        """
        Function that handles user input for different. As long as
        ...
        while True:
            try:
                ...
                print(f"{Fore.RED}Not an integer, try again")
...
class PlayerGuesses(Helper):
    ...
    def play(self):
        ...
        print(f"{Fore.GREEN}You got it! The number was: {random_number_100}")
        print(f"{Fore.GREEN}You guessed it in {self.guesses} attempts!")
...
class CoinToss(Helper):
    ...
    def play(self):
        ...
        input(f"{Fore.YELLOW}Press enter to begin...")
