...
def number_handler(string):
    ...
    """
    while True:
        variable100 = get_int(string)
        if variable100 >= 1 and variable100 <= 100:
            return variable100
        else:
            print("Input is not between 1 and 100")


def three_option_handler(string):
    """
    Function that handles user's chosen number for use in
    the ai guessing game
    """
    while True:
        variable3 = get_int(string)
        if variable3 >= 1 and variable3 <= 3:
            return variable3
        else:
...
def comp_guessing_function():
    ...
    user_response = number_handler("Enter your chosen number here: ")
    ...
    while True:
        ...
        user_response = three_option_handler("")
        if user_response == 1:
