...
class Computer_Guesses(Helper):
    ...
    def play(self):
        ...
        print(f"Hoorah! I guessed your number in {self.guesses} attempts!")
...
class Games(Helper):
    ...
    def __init__(self):
        super().__init__()
        self.game1 = Player_Guesses()
        self.game2 = Computer_Guesses()
        self.game3 = Coin_Toss()
